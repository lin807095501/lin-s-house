...
def get_args():
    ...
    parser.add_argument('--name', type=str, default='adaad_iad_adaptive_epsilon_adjuststudent_mvv2')
    parser.add_argument('--dataset', type=str, default='CIFAR100')
    parser.add_argument('--model', type=str, default='mobilenetV2')
    parser.add_argument('--method', type=str, default='AdaAD_IAD')

    parser.add_argument('--teacher_model', type=str, default='Chen2021WRN34_10')
...
if args.dataset == 'CIFAR10':
    ...
    if args.method not in ['Plain_Clean', 'Plain_Madry']:
        if args.teacher_model == 'Chen2021WRN34_10':
            ...
            teacher_path = '/amax/data/lsb/AdaAD_cat/teacher_ckpt/Chen2021LTD_cifar100.pt'
            teacher_state_dict = torch.load(teacher_path)
