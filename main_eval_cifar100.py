...
model_path = '/amax/data/lsb/AdaAD_cat/CIFAR100/AdaAD_IAD/adaad_iad_adaptive_epsilon_adjuststudent_nvv2/best_PGD10_acc_model.pth'  # The model path you want to evaluate
...
print('Evaluate PGD-10:')
test_robust(net, attack_type='pgd', c=args.eps, num_classes=num_classes,
            testloader=testloader, loss_fn=nn.CrossEntropyLoss(), req_count=10000)
print('Evaluate PGD-50:')
test_robust(net, attack_type='pgd', c=args.eps, num_classes=num_classes,
            testloader=testloader, loss_fn=nn.CrossEntropyLoss(), req_count=10000,nb_iter=50)
# print('Evaluate CW:')
